const projects = [
  {
    ...
    files: [
      { name: "keyInHands Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "keyInHands Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "keyInHands Logo.Zip", size: "2.02 MB", link: "#" },
