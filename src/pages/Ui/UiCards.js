...
class UiCards extends Component {
  ...
  render() {
    //meta title
    document.title = "Cards | keyInHands - React Admin & Dashboard Template";
    return (
      <React.Fragment>
        <div className="page-content">
          <Container fluid={true}>
            ...
            <Row>
              <Col md={6} xl={3}>
                <Card>
                  <CardImg top className="img-fluid" src={img1} alt="keyInHands" />
                  <CardBody>
              ...
              <Col mg={6} xl={3}>
                <Card>
                  <CardImg top className="img-fluid" src={img2} alt="keyInHands" />
                  <CardBody>
                    <CardTitle className="h4 mt-0">Card title</CardTitle>
                    <CardText>
                      Some quick example text to build on the card title and
              ...
              <Col mg={6} xl={3}>
                <Card>
                  <CardImg top className="img-fluid" src={img3} alt="keyInHands" />
                  <CardBody>
                    <CardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card&apos;s content.
              ...
              <Col md={6} xl={3}>
                <Card>
                  ...
                  <CardImg className="img-fluid" src={img4} alt="keyInHands" />
                  <CardBody>
                    <CardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card&apos;s content.
            ...
            <Row>
              <Col lg={4}>
                <Card>
                  <CardImg top className="img-fluid" src={img5} alt="keyInHands" />
                  <CardBody>
              ...
              <Col lg={4}>
                <Card>
                  <CardImg className="img-fluid" src={img6} alt="keyInHands" />
                  <CardImgOverlay>
              ...
              <Col lg={6}>
                <Card>
                  <Row className="no-gutters align-items-center">
                    <Col md={4}>
                      <CardImg className="img-fluid" src={img2} alt="keyInHands" />
                    </Col>
                    <Col md={8}>
                      <CardBody>
              ...
              <Col lg={6}>
                <Card>
                  <Row className="no-gutters align-items-center">
                    ...
                    <Col md={4}>
                      <CardImg className="img-fluid" src={img3} alt="keyInHands" />
                    </Col>
                  </Row>
                </Card>
              </Col>
              ...
              <Col className="col-12 mb-4">
                ...
                <CardDeck className="card-deck-wrapper">
                  <div className="card-group">
                    <Card className="mb-4">
                      <CardImg top className="img-fluid" src={img4} alt="keyInHands" />
                      <CardBody>
                        <CardTitle className="mt-0">Card title</CardTitle>
                        <CardText>
                    ...
                    <Card className="mb-4">
                      <CardImg top className="img-fluid" src={img6} alt="keyInHands" />
                      <CardBody>
                        <CardTitle className="mt-0">Card title</CardTitle>
                        <CardText>
                          This is a wider card with supporting text below as a
            ...
            <Row>
              <Col sm={12}>
                ...
                <CardColumns>
                  <Card>
                    <CardImg top src={img3} alt="keyInHands" />
                    <CardBody>
                  ...
                  <Card>
                    <CardImg top src={img5} alt="keyInHands" />
                    <CardBody>
                      <CardTitle className="h5">Card title</CardTitle>
                      <CardText>
                        This card has supporting text below as a natural lead-in
                  ...
                  <Card>
                    <CardImg top src={img7} alt="keyInHands" />
                  </Card>
