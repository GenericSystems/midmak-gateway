...
class StudentsList extends Component {
  ...
  toggleTab(tab) {
    ...
    if ((tab == 4 || tab == 3 || tab == 2 || tab == 1) && isEdit == false) {
      ...
      this.setState({
        stdDocsArray:
          !stdDocsArray.length ? tempStudent_regReqDocs : stdDocsArray,
      });
    }
  }
...
const mapStateToProps = ({
  ...
  generated_student: students.generated_student,
  tempStudent: students.tempStudent,
  generatedStudent: students.generatedStudent,
  last_created_student: students.last_created_student,
  tempStudent_regReqDocs: students.tempStudent_regReqDocs,
  tempStudentBrothers: students.tempStudentBrothers,
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(withTranslation()(StudentsList)));
