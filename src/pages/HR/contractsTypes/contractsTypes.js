...
class ContractsTypesList extends Component {
  ...
  componentDidMount() {
    const { contractsTypes, onGetContractsTypes, deleted, user_menu } =
      this.props;
    this.updateShowAddButton(user_menu, this.props.location.pathname);
    this.updateShowDeleteButton(user_menu, this.props.location.pathname);
    this.updateShowEditButton(user_menu, this.props.location.pathname);
    this.updateShowSearchButton(user_menu, this.props.location.pathname);
    // if (contractType && !contractsTypes.length) {
    //   onGetContractsTypes();
    // }
    onGetContractsTypes();
  ...
  handleDeleteRow = () => {
    const { onDeleteContractType } = this.props;
    const { selectedRowId } = this.state;

    if (selectedRowId !== null) {
      onDeleteContractType(selectedRowId);
  ...
  handleSelectFaculty(rowId, fieldName, newValue) {
    const { onUpdateContractType } = this.props;
    const onUpdate = { Id: rowId, [fieldName]: newValue };
    onUpdateContractType(onUpdate);
  }

  handleSuccessClose = () => {
    const { onGetContractTypeDeletedValue } = this.props;
    this.setState({ showAlert: null });
    onGetContractTypeDeletedValue();
  };
  ...
  render() {
    const { contractsTypes, t, deleted } = this.props;
    const {
      duplicateError,
      deleteModal,
      showAlert,
    ...
    const columns = [
      ...
      {
        dataField: "arTitle",
        text: this.props.t("Contract Type(ar)"),
        sort: true,
      ...
      <React.Fragment>
        ...
        <div className="page-content">
          <div className="container-fluid">
            <Breadcrumbs breadcrumbItem={this.props.t("ContractsTypes")} />
            <Row>
              <Col>
                <Card>
                  <CardBody>
...
const mapStateToProps = ({ contractsTypes, menu_items }) => ({
  contractsTypes: contractsTypes.contractsTypes,
  deleted: contractsTypes.deleted,
  user_menu: menu_items.user_menu || [],
});

const mapDispatchToProps = dispatch => ({
  onGetContractsTypes: () => dispatch(getContractsTypes()),
  onAddNewContractType: contractType =>
    dispatch(addNewContractType(contractType)),
  onUpdateContractType: contractType =>
    dispatch(updateContractType(contractType)),
  onDeleteContractType: contractType =>
    dispatch(deleteContractType(contractType)),
  onGetContractTypeDeletedValue: () => dispatch(getContractTypeDeletedValue()),
});

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withTranslation()(ContractsTypesList));
