...
//   }
// }
function* fetchAllCoursesRegistration() {
  const get_allCoursesRegistration_req = {
    source: "db",
    procedure: "SisApp_getData",
    apikey: "30294470-b4dd-11ea-8c20-b036fd52a43e",
    tablename: "Common_CoursesCatalogAll",
  };
  try {
    const response = yield call(
      getAllCoursesRegistration,
      get_allCoursesRegistration_req
    );
    yield put(getAllCoursesRegistrationSuccess(response));
  } catch (error) {
    yield put(getAllCoursesRegistrationFail(error));
  }
}
function* fetchCoursesRegistration() {
  ...
  try {
    ...
    console.log("Sectorsssssssssssssssssss", response);
  ...
  try {
    ...
    console.log("TrainingFormats", response);
  ...
  try {
    ...
    console.log("ceeeeeeeeeeeeeer", response);
...
function* coursesRegistrationSaga() {
  ...
  yield takeEvery(GET_ALL_COURSES_REGISTRATION, fetchAllCoursesRegistration);
