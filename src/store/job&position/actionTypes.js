...
/*POSITIONSS_OPT */
export const GET_POSITIONS_OPT = "GET_POSITIONS_OPT";
export const GET_POSITIONS_OPT_SUCCESS = "GET_POSITIONS_OPT_SUCCESS";
export const GET_POSITIONS_OPT_FAIL = "GET_POSITIONS_OPT_FAIL";
