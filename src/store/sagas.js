...
import PositionsSaga from "./job&position/saga";
...
import TraineesDeserveDeprivationSaga from "./traineesDeservesDeprivation/saga";
...
export default function* rootSaga() {
  yield all([
    ...
    fork(TraineesDeserveDeprivationSaga),
