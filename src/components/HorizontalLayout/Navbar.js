                  ...
                  <li className="nav-item dropdown">
                    ...
                    >
                      <div className="dropdown">
                        ...
                        >
                          {this.props.t("University System")} <div className="arrow-down" />
                        </Link>
                        <div
                          className={classname("dropdown-menu", {
                        ...
                        >
                          <Link to="/university-organize-structure" className="dropdown-item">
                            {this.props.t("University Organizational Structure")}
                          </Link>
                        </div> 
                      </div>
                    </div>
                  ...
                  <li className="nav-item dropdown">
                    ...
                    >
                      <div className="dropdown">
                        ...
                        >
                          <Link to="/university-def" className="dropdown-item">
                            {this.props.t("University Definition")}
                          </Link>
                        </div> 
                      </div>
                    </div>
