          ...
          <SimpleBar style={{ height: "900px" }}>
            <div data-simplebar className="h-100">
              ...
              <div className="p-4">
                ...
                <div className="mb-2">
                  <Link
                    to="//keyInHands-v-light.react.keyinhands.com"
                    target="_blank"
                  >
                    <img
                      src={layout4}
                ...
                <div className="mb-2">
                  <Link
                    to="//keyInHands-v-dark.react.keyinhands.com"
                    target="_blank"
                  >
                    <img
                      src={layout5}
                ...
                <div className="mb-2">
                  <Link
                    to="//keyInHands-v-rtl.react.keyinhands.com"
                    target="_blank"
                  >
                    <img
                      src={layout6}
                ...
                <Link
                  to="//1.envato.market/keyInHandsreact"
